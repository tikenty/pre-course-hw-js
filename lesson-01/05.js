...
ruleLength('Еще не родился тот человек, который поставил бы цель и не смог бы стать программистом.')
ruleLength('Еще не родился')
ruleLength('Еще не родился тот челове')
